...
2. open the asset inside the viewer in **Codex built-in browser** at the viewer URL recorded in `summary.json`, for example http://localhost:3000/glb_viewer.html?src=artifacts/headless-agent/headless-run-id/glb/asset-for-inspection.glb
3. view the asset
